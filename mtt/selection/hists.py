...
from mtt.util import has_tag, IF_MC
...
def mtt_selection_hists(
    ...
    **kwargs,
    ...
    event_masks = {
        ...
        "all_but_2d_iso": results.steps.all_but_2d_iso,
        "all_but_trigger": results.steps.all_but_trigger,
        "all_but_trigger_and_2d_iso": results.steps.all_but_trigger_and_2d_iso,
...
@mtt_selection_hists.setup
def mtt_selection_hists_setup(
...
@mtt_selection_hists.init
def mtt_selection_hists_init(self: Selector) -> None:
